...
async function fetchProposalData(proposalNumber) {
  ...
  const whatsNextHtml = richToHtml(proposal["What's Next"])
    || "<p>Once you're good with this proposal, let us know, and we'll send you a Dropbox Sign to finalize. From there, we'll connect on the details of the deliverables we're working on with you.</p>";
